...
function Footer() {
  return (
    <div className='mt-5 bg-light border-top  '>

      <div className="container">
        <div className="row p-5">
          <div className="col footer-section">
            <img src="media/Images/logo.svg" alt="logo_IMG_ERR" className='mb-3' style={{width:"70%"}} />
            <p className=''>&copy; 2010-2025, Zerodha Broking Ltd.
              All rights reserved.
            </p>
        ...
        <div className="row footer-text-section px-5 ">
          <p>
        ...
        <div className='col text-center d-flex align-item-center justify-content-center footer-link-section gap-3 p-2 mb-3'>
